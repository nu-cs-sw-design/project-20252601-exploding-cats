...
//		final int expectedDeckSize = 34;
		final int threeCards = 3;
		// NOTE: ADJUSTED DECK SIZE GIVEN NOT ALL CARDS IMPLEMENTED
...
//		EasyMock.replay(rand, instantiator, firstCard, maxSizeDeck, secondCard);
//
//		Deck deck = new Deck(maxSizeDeck, rand, 0,
...
//				card3, card4, implodingKittenCard);
//
//		Deck deck = new Deck(fourCardsDeck, rand, 0, maxDeckSize, instantiator);
//
